...
public class LogUtil {
    private static final String DEFAULT_TAG = "Blinger_____";
    ...
    private static StackTraceElement getTargetStackTraceElement() {
        ...
        for (StackTraceElement stackTraceElement : stackTrace) {
            boolean isLogMethod = stackTraceElement.getClassName().equals(LogUtil.class.getName()) || stackTraceElement.getClassName().startsWith("java.lang");
